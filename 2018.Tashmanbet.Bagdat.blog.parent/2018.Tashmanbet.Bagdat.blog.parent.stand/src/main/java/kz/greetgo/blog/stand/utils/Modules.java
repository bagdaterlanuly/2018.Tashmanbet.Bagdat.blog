...
public class Modules {
    ...
    private static File findDir(String moduleName) {
...

        {
            ...
            try {
                if (dir.isDirectory() &&
                        dir.toPath().resolve("..").toFile().getCanonicalFile().getName().equals("2018.Tashmanbet.Bagdat.blog.parent")) {
                    return dir;
                }
            } catch (IOException e) {
    ...
    public static File controllerDir() {
        return findDir("2018.Tashmanbet.Bagdat.blog.parent.controller");
    }
